...
METRICS_FILE = "cnn_metrics_resnet_rgb.csv"  # CHANGE
EPOCHS = 100  # CHANGE
CHECKPOINT_BASENAME = "DLmodels_resnet/checkpoint_rgb"  # CHANGE
...
VAL_DATASET = PCAM_dataset_rgb(val_folder, None, NWORKERS)  # CHANGE

print("WILL READ TRAIN DATA")
TRAIN_DATASET = PCAM_dataset_rgb(train_folder, None, NWORKERS)  # CHANGE
...
TEST_DATASET = PCAM_dataset_rgb(test_folder, test_transform, NWORKERS)  # CHANGE

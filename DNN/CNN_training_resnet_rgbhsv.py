...
METRICS_FILE = "cnn_metrics_resnet_rgbhsv.csv"  # CHANGE
EPOCHS = 100  # CHANGE
CHECKPOINT_BASENAME = "DLmodels_resnet/checkpoint_rgbhsv"  # CHANGE
...
VAL_DATASET = PCAM_dataset_rgb_hsv(val_folder, None, NWORKERS)  # CHANGE

print("WILL READ TRAIN DATA")
TRAIN_DATASET = PCAM_dataset_rgb_hsv(train_folder, None, NWORKERS)  # CHANGE
...
TEST_DATASET = PCAM_dataset_rgb_hsv(test_folder, test_transform, NWORKERS)  # CHANGE

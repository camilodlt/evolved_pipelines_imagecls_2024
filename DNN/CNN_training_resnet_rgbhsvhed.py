...
METRICS_FILE = "cnn_metrics_resnet_rgbhsvhed.csv"  # CHANGE
EPOCHS = 100  # CHANGE
CHECKPOINT_BASENAME = "DLmodels_resnet/checkpoint_rgbhsvhed"  # CHANGE
...
VAL_DATASET = PCAM_dataset_rgb_hsv_hed(val_folder, None, NWORKERS)  # CHANGE

print("WILL READ TRAIN DATA")
TRAIN_DATASET = PCAM_dataset_rgb_hsv_hed(train_folder, None, NWORKERS)  # CHANGE
...
)  # exactly the same but with 1 as in channels CHANGE
...
TEST_DATASET = PCAM_dataset_rgb_hsv_hed(test_folder, test_transform, NWORKERS)  # CHANGE
